...
import cn.itcast.mapreduce.flow_count_demo1.FlowCountReducer;
...
//        创建一个job任务对象
        final Job job = Job.getInstance(super.getConf(), "mapreduce_flowsort");
        //        如果打包运行出错，则需要加该配置
...
//        final Path path = new Path("hdfs://node01:8020/wordcount_out");
        final Path path = new Path("file:///D:\\out\\flowsort_out");
